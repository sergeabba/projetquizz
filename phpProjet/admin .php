...
<div style="background-color: #fefefe;width: 936px;height: 666px;margin: 3px -2px 7px 73px;padding: 0px;">
    <div class="d-flex" style="background-color: #51bfd0;height: 72px;">
        <h1 style="font-family: 'Alegreya Sans SC', sans-serif;font-size: 38px;margin: 13px 106px 0px 195px;color: rgb(248,253,253);">créer et paramétrer vos quizz</h1><button class="btn btn-primary"  type="button" style="height: 39px;width: 134px;margin: 17px 0px 0px 0px;background-color: rgb(58,221,214);">
            Déconnexion 
         </button>
    </div>
