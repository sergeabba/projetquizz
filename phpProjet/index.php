...
<body style="">
    ...
    <div style="background-color: #fefefe;width: 484px;height: 400px;margin: 40px -2px 99px 295px;">
        ...
        <div
            ...
            <button name="connexion"  type="submit" style="margin: 27px -21px 0px 24px;height: 43px;background-color: rgb(81,191,208);color: rgb(248,253,253);">
                Connexion
            </button><a href="user.php" style="margin: 25px 0px 0px 69px;font-size: 20px;color: rgb(129,129,129);">
